...
/**
 * Loads the newest `limit` posts across every category, for Home's "Latest
 * Updates" feed. No pagination -- it's a fixed-size teaser, not a full list,
 * so there is no `loadMore` the way `usePosts` has one.
 */
